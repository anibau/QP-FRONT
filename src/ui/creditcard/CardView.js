...
export default function CardView(props) {
  ...
  useEffect(() => {
    rotation.value = withTiming(shouldFlip ? 1 : 0, { duration: 400 });
  }, [shouldFlip]);
  ...
  return (
    <View style={[s.cardContainer, containerSize]}>
      {/* FRONT */}
      <Animated.View style={[s.cardFace, frontStyle]}>
        <ImageBackground
          style={[BASE_SIZE, transform]}
          source={imageFront}
        >
      ...
      {/* BACK */}
      <Animated.View style={[s.cardFace, backStyle]}>
        <ImageBackground
          style={[BASE_SIZE, transform]}
          source={imageBack}
        >
